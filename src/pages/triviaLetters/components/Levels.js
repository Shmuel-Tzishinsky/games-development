            ...
            <div className="level-data-cont">
                {dataArray.map((e, i) => (
                    ...
                    <div key={i} className={`level-line level-line-${e[0] % 3 === 2  ? 'two' :'one' }  `}>
                        ...
                        {e.map((obj,ind) => (
                            <div id={obj === selectLevel ? "current" : ''}  key={ind} className={`level-line-afBfo level-${ind % 2 === 0 ? 'before' : 'after'}  ${obj < selectLevel ? "level-completed " : obj === selectLevel ? "current": '' }`}> 
...
export const LockedUp__icon = ( () =>  <div className="level-locked">
                            <svg viewBox="0 0 24 24">
                                <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"></path>
                            </svg>
                        </div>)
const start__icon  = ( () => <svg viewBox="0 0 24 24" >
